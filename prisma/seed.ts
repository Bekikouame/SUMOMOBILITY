...
async function main() {
  console.log('📧 Seed des templates de notification...');
  ...
  const templates = [
    ...
    },
    {
      ...
      language: 'fr',
      title: '🚕 Nouvelle course disponible',
      body: 'Course de {{pickup}} vers {{destination}}\nClient: {{clientName}}\nDistance: {{distance}}\nPrix: {{estimatedFare}}',
      variables: ['pickup', 'destination', 'clientName', 'distance', 'estimatedFare'],
      priority: 1,
    },
...
L'équipe Sumo`,
    ...
    },
    {
      ...
      language: 'fr',
      title: '✅ Course acceptée',
      body: '{{driverName}} arrive dans {{estimatedArrival}}\nVéhicule: {{vehiclePlate}}',
      variables: ['driverName', 'vehiclePlate', 'estimatedArrival'],
      priority: 1,
    },

    // ==========================================
    // 🔥 RIDE_STARTED (NOUVEAU)
    // ==========================================
    {
...
L'équipe Sumo`,
    ...
    },
    {
      ...
      language: 'fr',
      title: '✅ Course terminée',
      body: 'Trajet terminé\nDistance: {{distance}}km\nDurée: {{duration}}\nMontant: {{totalFare}} FCFA',
      variables: ['distance', 'duration', 'totalFare'],
      priority: 1,
    },

    // ==========================================
    // 🔥 RIDE_CANCELED (NOUVEAU)
    // ==========================================
    {
    ...
    },
    {
      ...
      language: 'fr',
      title: '❌ Course annulée',
      body: 'La course de {{pickup}} vers {{destination}} a été annulée par {{canceledBy}}.\nRaison: {{reason}}',
...
L'équipe Sumo`,
    ...
    // ==========================================
    {
      ...
      body: 'Votre {{docType}} a été approuvé',
      variables: ['docType'],
      priority: 2,
    },
    ...
    // ==========================================
    {
      ...
      body: 'Votre {{docType}} a été rejeté. Raison: {{reason}}',
      variables: ['docType', 'reason'],
      priority: 1,
    },
    ...
    },
    {
      ...
      body: 'Le paiement de {{amount}} FCFA a échoué. Veuillez réessayer.',
      variables: ['amount'],
      priority: 1,
    },
    ...
    // ==========================================
    {
      ...
      body: 'Maintenance du système le {{maintenanceDate}} de {{startTime}} à {{endTime}}',
      variables: ['maintenanceDate', 'startTime', 'endTime'],
      priority: 3,
    },
    // ==========================================
    // 🚗 NOUVEAU COVOITURAGE DISPONIBLE
    // ==========================================
    {
      type: NotificationType.NEW_CARPOOL_AVAILABLE,
      channel: NotificationChannel.PUSH,
      language: 'fr',
      title: '🚗 Nouveau covoiturage disponible !',
      body: 'De {{pickupAddress}} à {{destinationAddress}} le {{scheduledAt}}. {{availableSeats}} place(s) à {{pricePerPerson}} FCFA',
      variables: ['pickupAddress', 'destinationAddress', 'scheduledAt', 'pricePerPerson', 'availableSeats'],
      priority: 5,
    },
    {
      type: NotificationType.NEW_CARPOOL_AVAILABLE,
      ...
      language: 'fr',
      title: '🚗 Nouveau covoiturage disponible',
      body: 'Un chauffeur propose un covoiturage de {{pickupAddress}} à {{destinationAddress}} le {{scheduledAt}}. {{availableSeats}} place(s) disponibles à {{pricePerPerson}} FCFA par personne.',
      variables: ['pickupAddress', 'destinationAddress', 'scheduledAt', 'pricePerPerson', 'availableSeats'],
      priority: 5,
    },
  ];
  ...
  console.log(` ${templates.length} templates de notification créés / mis à jour`);
}
